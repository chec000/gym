...
CREATE TABLE `asistencias` (
  ...
  CONSTRAINT `asistencia_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `caracteristicas_cliente` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `caracteristicas_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `caracteristicas_cliente`
--

LOCK TABLES `caracteristicas_cliente` WRITE;
/*!40000 ALTER TABLE `caracteristicas_cliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `caracteristicas_cliente` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cliente_dieta` (
  ...
  CONSTRAINT `cliente_dienta` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `dieta_cliente` FOREIGN KEY (`id_dieta`) REFERENCES `dieta` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cliente_dieta`
--

LOCK TABLES `cliente_dieta` WRITE;
/*!40000 ALTER TABLE `cliente_dieta` DISABLE KEYS */;
/*!40000 ALTER TABLE `cliente_dieta` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `comentarios` (
  ...
  CONSTRAINT `comentario_empresa` FOREIGN KEY (`id_empresa`) REFERENCES `empresas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `configuracion_precio_membrecia`
--

LOCK TABLES `configuracion_precio_membrecia` WRITE;
/*!40000 ALTER TABLE `configuracion_precio_membrecia` DISABLE KEYS */;
/*!40000 ALTER TABLE `configuracion_precio_membrecia` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `contacto_cliente` (
  ...
  CONSTRAINT `contacto_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `deporte_horario` (
  ...
  CONSTRAINT `depore_horario` FOREIGN KEY (`id_horario`) REFERENCES `horarios_depor` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `deporte_horario` FOREIGN KEY (`id_deporte`) REFERENCES `deportes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `deporte_horario`
--

LOCK TABLES `deporte_horario` WRITE;
/*!40000 ALTER TABLE `deporte_horario` DISABLE KEYS */;
/*!40000 ALTER TABLE `deporte_horario` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `deportes` (
  ...
  CONSTRAINT `entranador_deporte` FOREIGN KEY (`id_entrenador`) REFERENCES `entrenadores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `deportes_cliente` (
  ...
  CONSTRAINT `cliente` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `deporte` FOREIGN KEY (`id_deporte`) REFERENCES `deportes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `deportes_cliente`
--

LOCK TABLES `deportes_cliente` WRITE;
/*!40000 ALTER TABLE `deportes_cliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `deportes_cliente` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `detalle` (
  ...
  CONSTRAINT `producto` FOREIGN KEY (`id_p`) REFERENCES `deportes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `venta` FOREIGN KEY (`id_v`) REFERENCES `ventas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `usuario_empleado` FOREIGN KEY (`id_usuario`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entrenadores` (
  ...
  CONSTRAINT `entrenador_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `estado` (
  ...
  CONSTRAINT `estado_pais` FOREIGN KEY (`pais_id`) REFERENCES `pais` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
--
-- Dumping data for table `horario_entrenador`
--

LOCK TABLES `horario_entrenador` WRITE;
/*!40000 ALTER TABLE `horario_entrenador` DISABLE KEYS */;
/*!40000 ALTER TABLE `horario_entrenador` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `horarios_depor`
--

LOCK TABLES `horarios_depor` WRITE;
/*!40000 ALTER TABLE `horarios_depor` DISABLE KEYS */;
/*!40000 ALTER TABLE `horarios_depor` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `horarios_entrenadores`
--

LOCK TABLES `horarios_entrenadores` WRITE;
/*!40000 ALTER TABLE `horarios_entrenadores` DISABLE KEYS */;
/*!40000 ALTER TABLE `horarios_entrenadores` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `migrations` VALUES (5,'2018_08_11_220627_create_roles_table',1),(6,'2018_08_11_220748_create_role_user_table',1);
...
INSERT INTO `password_resets` VALUES ('sergioshutdown@gmail.com','$2y$10$yvbtC7d2Cfk/q2nk.L9BA.MhDihnH/oAdd/kidlogwLvNBB/o34em','2018-08-20 11:01:56'),('sgalindo.smartsoft@gmail.com','$2y$10$XAHM9lFL2LuiQ95cF/YV5O6msTbwy.bbMU1iUarR/VQ5f4Fm.fc/2','2018-08-14 20:38:31');
...
CREATE TABLE `proveedores` (
  ...
  CONSTRAINT `usuario_proveedor` FOREIGN KEY (`id_usuario`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rendimiento_encuesta` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `id_entrenador` int(10) NOT NULL,
...
--
-- Dumping data for table `rendimiento_encuesta`
--

LOCK TABLES `rendimiento_encuesta` WRITE;
/*!40000 ALTER TABLE `rendimiento_encuesta` DISABLE KEYS */;
/*!40000 ALTER TABLE `rendimiento_encuesta` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `respuestas` (
  ...
  CONSTRAINT `respuesta_pregunta` FOREIGN KEY (`id_pregunta`) REFERENCES `encuestas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `role_user` VALUES (1,2,1,'2018-08-12 03:42:27','2018-08-12 03:42:27'),(2,1,2,'2018-08-12 03:42:27','2018-08-12 03:42:27'),(3,2,4,'2018-08-14 19:34:16','2018-08-14 19:34:16'),(4,2,5,'2018-08-20 11:01:18','2018-08-20 11:01:18');
...
INSERT INTO `roles` VALUES (1,'admin','Administrator','\0','2018-08-12 03:42:26','2018-08-12 03:42:26'),(2,'user','User','\0','2018-08-12 03:42:26','2018-08-12 03:42:26');
...
CREATE TABLE `users` (
  ...
  `apellido_materno` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pais_user_idx` (`pais`),
  KEY `estado_idx` (`estado`),
  CONSTRAINT `estado` FOREIGN KEY (`estado`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `pais_user` FOREIGN KEY (`pais`) REFERENCES `pais` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users` VALUES (5,'shsjdhjhjh','jh','jhjhjh','76767676','76767676','soltero',18,832,832,'sjashaj',1,1,'sergioshutdown@gmail.com','$2y$10$PiepFRKbyFQHexOljGdGq.kKkrdwjt7qyj3LmR13OPKxll3vEP976','F0vb5BhMWtLiBRjhmztcPTuYP9HlV670BuPiu3dJaXE6yD3eSBf8NvRr3xsb','2018-08-20 11:01:17','2018-08-20 11:01:17');
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT ` ventaEmpleado` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `ventaCliente` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-20  1:13:03
