...
INSERT INTO `beneficios` (`id`, `nombre`, `descripcion`, `activo`) VALUES
(1, 'entrenadores', 'asasa', b'1'),
(2, 'clases de baile', 'asasasa', b'1');
...
--
-- Table structure for table `membresia_deporte`
--
...
('sergioshutdown@gmail.com', '$2y$10$yvbtC7d2Cfk/q2nk.L9BA.MhDihnH/oAdd/kidlogwLvNBB/o34em', '2018-08-20 11:01:56'),
...
(1, 'admin', 'Administrator', b'0', '2018-08-12 03:42:26', '2018-08-12 03:42:26'),
(2, 'user', 'User', b'0', '2018-08-12 03:42:26', '2018-08-12 03:42:26');
...
--
-- Table structure for table `tipomembresia`
--
...
--
-- Dumping data for table `tipomembresia`
--
...
ALTER TABLE `asistencias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `asistencia_cliente_idx` (`id_cliente`);
...
--
-- Indexes for table `caracteristicas_cliente`
--
ALTER TABLE `caracteristicas_cliente`
  ADD PRIMARY KEY (`id`),
  ADD KEY `caracteristicas_cliente_idx` (`id_cliente`);
...
--
-- Indexes for table `cliente_dieta`
--
ALTER TABLE `cliente_dieta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cliente_dienta_idx` (`id_cliente`),
  ADD KEY `dieta_cliente_idx` (`id_dieta`);
...
ALTER TABLE `comentarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comentario_empresa_idx` (`id_empresa`);
...
--
-- Indexes for table `configuracion_precio_membrecia`
--
...
ALTER TABLE `contacto_cliente`
  ADD PRIMARY KEY (`id`),
  ADD KEY `contacto_cliente_idx` (`id_cliente`);
...
ALTER TABLE `deportes_cliente`
  ...
  ADD KEY `deporte_idx` (`id_deporte`);

--
-- Indexes for table `deporte_horario`
--
ALTER TABLE `deporte_horario`
  ADD PRIMARY KEY (`id`),
  ADD KEY `depore_horario_idx` (`id_horario`),
  ADD KEY `deporte_horario_idx` (`id_deporte`);
...
ALTER TABLE `detalle`
  ADD PRIMARY KEY (`id`),
  ADD KEY `venta_idx` (`id_v`),
  ADD KEY `producto_idx` (`id_p`);
...
ALTER TABLE `empleados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `usuario_empleado_idx` (`id_usuario`);
...
ALTER TABLE `entrenadores`
  ADD PRIMARY KEY (`id`),
  ADD KEY `entrenador_usuario_idx` (`id_usuario`);
...
--
-- Indexes for table `horarios_depor`
--
ALTER TABLE `horarios_depor`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `horarios_entrenadores`
--
ALTER TABLE `horarios_entrenadores`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `membresia_deporte`
--
...
--
-- Indexes for table `pedido_compra`
--
...
ALTER TABLE `proveedores`
  ADD PRIMARY KEY (`id`),
  ADD KEY `usuario_proveedor_idx` (`id_usuario`);

--
-- Indexes for table `rendimiento_encuesta`
--
ALTER TABLE `rendimiento_encuesta`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `respuestas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `respuesta_pregunta_idx` (`id_pregunta`);
...
--
-- Indexes for table `tipomembresia`
--
...
ALTER TABLE `ventas`
  ...
  ADD KEY ` ventaEmpleado` (`id_empleado`);
...
--
-- AUTO_INCREMENT for table `configuracion_precio_membrecia`
--
ALTER TABLE `configuracion_precio_membrecia`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `deporte_horario`
--
ALTER TABLE `deporte_horario`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `horarios_depor`
--
ALTER TABLE `horarios_depor`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `horarios_entrenadores`
--
ALTER TABLE `horarios_entrenadores`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `horario_entrenador`
--
ALTER TABLE `horario_entrenador`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `pedido_compra`
--
ALTER TABLE `pedido_compra`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `rendimiento_encuesta`
--
ALTER TABLE `rendimiento_encuesta`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `pais_user` FOREIGN KEY (`pais`) REFERENCES `pais` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
